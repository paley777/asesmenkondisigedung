    ...
    <section class="py-5 py-xl-5  mt-5" style="margin-top: 2vw;">
        <div class="container">
            ...
            <div class="row mb-4 align-items-center justify-content-between">
                ...
                <form class="row g-2" method="post" action="/dashboard/peta" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="col-md-9 position-relative">
                        <label for="validationCustom01" class="form-label ">Pemetaan 3D<span
                                class="text-danger">*</span></label>
                        <input type="file" id="validationCustom01" class="form-control" name="file" accept="image/*"
                            placeholder="Isi Pemetaan 3D" onchange="showPreview(event);" id="file-ip-1" required>
                    </div>
