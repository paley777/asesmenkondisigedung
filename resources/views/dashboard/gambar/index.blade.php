                ...
                <div class="col-auto">
                    <div class="page-utilities">
                        <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                            <div class="col-auto">
                                <a class="btn btn-primary" href="/dashboard/gambar/create">
                    ...
                    <table id="example1" class="table app-table-hover mb-0 text-left">
                        <thead>
                            <tr>
                                ...
                                <th class="cell">Foto Penelitian</th>
                        ...
                        <tbody>
                            @foreach ($gambars as $key => $gambar)
                                <tr>
                                    ...
                                    <td>{{ $gambar->sekolah->nama_sekolah }}</td>
                                    <td> <img src="{{ URL::asset($gambar->file) }}" class="img-fluid" style="width:300px;">
                                    </td>
                                    <td>
                                        <form action="/dashboard/gambar/{{ $gambar->id }}" method="post"
                                            class="d-inline">
                                            @method('delete')
                                            @csrf
