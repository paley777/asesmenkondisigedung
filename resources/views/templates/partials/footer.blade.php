            ...
            <div class="col-12 col-md-4">
                <div class="fw-bold d-flex align-items-center mb-2">
                    <div class="logo-container">
                        <img src="{{ URL::asset('images/logo.png') }}" width="45" height="45" class="card-img-top"
                            alt="Logo Universitas Bengkulu">
                    </div>
                    <div class="text-container">
                        <span class="pulse animated" style="font-size: 10pt;">Asesmen Kondisi Bangunan Gedung
                            Sekolah</span>
                    </div>
                </div>
                <p class="text-light">Situs informasi hasil asesmen kondisi bangunan gedung sekolah dasar di Kecamatan
                    Teluk Segara dan Kecamatan Ratu Samban, Kota Bengkulu, Provinsi Bengkulu.</p>
            </div>
            <div class="col-12 col-md-4 text-lg-start d-flex flex-column">
                <h3 class="fs-6 fw-bold">Tautan</h3>
                <ul class="list-unstyled">
                    <li data-bss-hover-animate="pulse">
                        <a class="navbar-brand" href="https://www.unib.ac.id/">
                            ...
                            </svg>Website Universitas Bengkulu</a>
                    </li>
                    <li data-bss-hover-animate="pulse">
                        <a class="navbar-brand" href="https://ft.unib.ac.id/">
                            <svg width="1.2em" height="1.2em" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                            ...
                            </svg>Website Fakultas Teknik Universitas Bengkulu</a>
                    </li>
                </ul>
            </div>
            <div class="col-12 col-md-4 text-lg-start d-flex flex-column">
                <h3 class="fs-6 fw-bold">Kontak Kami</h3>
                <ul class="list-unstyled">
                    <li>Ir. Annisa Fitria Edriani, S.T, M.EngSt</li>
                    <li>E-Mail: annisa.fe@unib.ac.id</li>
                    <li>Nomor Telp: +62-821-8595-7877</li>
                </ul>
            </div>
        </div>
        <hr>
        <div class="text-muted d-flex justify-content-between align-items-center pt-3">
            <p class="text-white mb-0">Copyright © 2023 Asesmen Kondisi Bangunan Gedung
                Sekolah</p>
